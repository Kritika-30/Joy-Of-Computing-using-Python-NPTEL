'''A semiprime number is an integer which can be expressed as a product of two distinct primes. For example 15 = 3*5 is a semiprime number
but 9 = 3*3 is not .
...
# li is list of semiprimes below 200
N = int(input())
if (N in li):
	print('Yes')
else:
